...
#'@param dropareas The table for the genomic location of centromere areas.
...
findsmears <- function(breakpoint_table, dropareas, smear = 2, keepboundaries = TRUE, mask_XY = TRUE){
